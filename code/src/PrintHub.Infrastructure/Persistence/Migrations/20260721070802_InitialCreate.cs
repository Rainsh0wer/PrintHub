        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceGroup = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultAddress = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeclaredPageCount = table.Column<int>(type: "int", nullable: true),
                    RightsDeclared = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentFiles_Users_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIndicative = table.Column<bool>(type: "bit", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopServices_ServiceTypes_ServiceTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopStaff_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    FulfilmentMethod = table.Column<int>(type: "int", nullable: false),
                    PickupSlotStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PickupSlotEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlatExtra = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceRules_ShopServices_ShopServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    ProposedResolution = table.Column<int>(type: "int", nullable: true),
                    ShopResponse = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    AdminRuling = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Complaints_Orders_ReplacementOrderId",
                        column: x => x.ReplacementOrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Complaints_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorMode = table.Column<int>(type: "int", nullable: true),
                    Sides = table.Column<int>(type: "int", nullable: true),
                    ...
                    QualityProfile = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    EstimatedGrams = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: true),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_DocumentFiles_DocumentFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Complaints_ReplacementOrderId",
                table: "Complaints",
                column: "ReplacementOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Complaints_ShopId",
                table: "Complaints",
                column: "ShopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_CustomerId_ShopId",
                table: "Favourites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_DocumentFileId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceRules_ShopServiceId",
                table: "PriceRules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopServices_ServiceTypeId",
                table: "ShopServices",
                column: "ServiceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopServices_ShopId_ServiceTypeId",
                table: "ShopServices",
                columns: new[] { "ShopId", "ServiceTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShopStaff_ShopId_UserId",
                table: "ShopStaff",
                columns: new[] { "ShopId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShopStaff_UserId",
                table: "ShopStaff",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_RefCode",
                table: "WalletTransactions",
                column: "RefCode",
                unique: true);
